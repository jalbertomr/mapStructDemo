...
@Slf4j
class CompanyMapperAdderPreferredTest {
    private CompanyMapperAdderPreferred companyMapperAdderPreferred = Mappers.getMapper(CompanyMapperAdderPreferred.class);

    @Test
    void companyToDto() throws ParseException {
        //given
        ...
        //when
        CompanyDto companyDto = companyMapperAdderPreferred.companyToDto(company);
